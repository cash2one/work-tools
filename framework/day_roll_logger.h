...
#define info_log_string(logger,content) write_log_string(logger,kingnet::day_roll_logger::LOG_LEVEL_INFO,content)

#ifdef NDEBUG
#define debug_log_format(logger,fmt,args...)
#define debug_log_string(logger,content)
#else
#define debug_log_format(logger,fmt,args...) write_log_format(logger,kingnet::day_roll_logger::LOG_LEVEL_DEBUG,fmt,##args)
#define debug_log_string(logger,content) write_log_format(logger,kingnet::day_roll_logger::LOG_LEVEL_DEBUG,content)
#endif
