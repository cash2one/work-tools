#ifndef _generate_h_wing_spirit_item 
#define _generate_h_wing_spirit_item 
#include "sql_binder.h"
class wing_spirit_item : public sql_binder 
{
public:
    wing_spirit_item();
...
public:
    ...
    void set_spirit_item_id(int64_t value) { if(spirit_item_id!= value){dirty[0] = 1; spirit_item_id = value;} } ; 
    ...
    void set_spirit_tid(int32_t value) { if(spirit_tid!= value){dirty[1] = 1; spirit_tid = value;} } ; 
    ...
    void set_spirit_level(int32_t value) { if(spirit_level!= value){dirty[2] = 1; spirit_level = value;} } ; 
    ...
    void set_spirit_add_exp(int64_t value) { if(spirit_add_exp!= value){dirty[3] = 1; spirit_add_exp = value;} } ; 
