#ifndef _generate_h_role_wing_item_info 
#define _generate_h_role_wing_item_info 
#include "sql_binder.h"
class role_wing_item_info : public sql_binder 
{
public:
    role_wing_item_info();
...
public:
    ...
    void set_wing_item_id(int64_t value) { if(wing_item_id!= value){dirty[1] = 1; wing_item_id = value;} } ; 
    ...
    void set_slot_1(int64_t value) { if(slot_1!= value){dirty[2] = 1; slot_1 = value;} } ; 
    ...
    void set_slot_2(int64_t value) { if(slot_2!= value){dirty[3] = 1; slot_2 = value;} } ; 
    ...
    void set_slot_3(int64_t value) { if(slot_3!= value){dirty[4] = 1; slot_3 = value;} } ; 
    ...
    void set_slot_4(int64_t value) { if(slot_4!= value){dirty[5] = 1; slot_4 = value;} } ; 
    ...
    void set_slot_5(int64_t value) { if(slot_5!= value){dirty[6] = 1; slot_5 = value;} } ; 
    ...
    void set_slot_6(int64_t value) { if(slot_6!= value){dirty[7] = 1; slot_6 = value;} } ; 
    ...
    void set_slot_7(int64_t value) { if(slot_7!= value){dirty[8] = 1; slot_7 = value;} } ; 
    ...
    void set_slot_8(int64_t value) { if(slot_8!= value){dirty[9] = 1; slot_8 = value;} } ; 
