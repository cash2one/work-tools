#ifndef _generate_h_role_wing_spirit_pool 
#define _generate_h_role_wing_spirit_pool 
#include "sql_binder.h"
class role_wing_spirit_pool : public sql_binder 
{
public:
    role_wing_spirit_pool();
...
public:
    ...
    void set_spirit_pos(int32_t value) { if(spirit_pos!= value){dirty[2] = 1; spirit_pos = value;} } ; 
